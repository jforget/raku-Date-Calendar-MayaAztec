...
unit class Date::Calendar::Mayan::Spinden:ver<0.0.1>:auth<cpan:JFORGET>
...
Date::Calendar::Mayan::Spinden - conversions from/to the Mayan calendar
...
my Date::Calendar::Mayan::Spinden
...
Date::Calendar::Mayan::Spinden is  a class which implements  the Mayan
